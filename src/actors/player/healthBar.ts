import { Engine, Label, Logger, ScreenElement,vec, Font, FontOptions, FontUnit, Color, Canvas, Actor, Line, Vector } from 'excalibur'
...
export class HpBar extends ScreenElement {
    ...
    constructor() {
        super({x:0,y:0,z:10,anchor: Vector.Half})
    }
