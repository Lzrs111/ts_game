...
export const weapons = {
    ...
    Ante: 
        {   
            levels: {
                ...
                3: {damage: 15,step: 0.06,radiusMultiplier:  1,scaleMultiplier: 1.2,projectiles: 3, text: "Ante level 3 "},
                4: {damage: 20,step: 0.06,radiusMultiplier:  1,scaleMultiplier: 1.2, projectiles:4,text: "Ante level 4"},
                5: {damage: 40,step: 0.1,radiusMultiplier:  1,scaleMultiplier: 1.2, projectiles: 5,text: "Ante level 5 "},
            },
    ...
    Blaster: {
        levels: {
            1: {damage: 20,attackSpeed: 750,projectileSpeed: 1000, text: "Sengulica"},
            2: {damage: 30,attackSpeed: 650,projectileSpeed: 1000,  text: "Sengula level 2"},
            3: {damage: 40,attackSpeed: 500,projectileSpeed: 1000,  text: "Sengula level 3"},
            4: {damage: 50,attackSpeed: 475,projectileSpeed: 1000,  text: "Sengula level 4"},
            5: {damage: 60,attackSpeed: 450,projectileSpeed: 1000,  text: "Sengula level 5"},
        },
    ...
    Bouncy: {
        levels: {
            1: {damage: 20,bounces:1,projectiles:1 ,attackSpeed: 1000, projectileSpeed: 1000, text: "Naspidirana glupača skače okolo"},
            2: {damage: 30,bounces:2,projectiles:1 ,attackSpeed: 1000, projectileSpeed: 1000,  text: " Kile level 2"},
            3: {damage: 40,bounces:2,projectiles:1 ,attackSpeed: 1000, projectileSpeed: 1000,  text: " Kile level 3"},
            4: {damage: 50,bounces:2,projectiles:1 ,attackSpeed: 1000, projectileSpeed: 1000,  text: " Kile level 4"},
            5: {damage: 55,bounces:3,projectiles:1 ,attackSpeed: 1000, projectileSpeed: 1000,  text: " Kile level 5"},
        },
